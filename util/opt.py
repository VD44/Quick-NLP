...
# taken (with minimal modification) from: https://github.com/openai/finetune-transformer-lm/blob/master/opt.py
...
def adam(params, grads, lr, schedule, t_total, warmup=0.002, b1=0.9, b2=0.999, e=1e-8, l2=0, vector_l2=False, max_grad_norm=-1, **kwargs):
    """
    ...
    for p, g in zip(params, grads):
        if p is None or g is None:
            ...
            lrt *= schedules[schedule](t/t_total)
            mt = b1*m + (1-b1)*g
            vt = b2*v + (1-b2)*g*g
